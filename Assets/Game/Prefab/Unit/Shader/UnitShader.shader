...
Shader "UnitShader"
{
	Properties
	{
		...
		[TCP2Separator]
		[TCP2Header(Blood)]
		[NoScaleOffset] Blood ("Blood", 2D) = "white" {}
		 _BloodAmount ("BloodAmount", Range(0,1)) = 0
		_Color_blood ("Color", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		void vertex_surface(inout appdata_tcp2 v, out Input output)
		{
			...
			output.texcoord1 = v.texcoord1.xy;
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float4 __mainColor_blood = ( _Color_blood.rgba );
			...
			float __layer_blood = saturate( TCP2_TEX2D_SAMPLE(Blood, Blood, input.texcoord1.xy).r * _BloodAmount );

			// Material Layers Blending
			 __mainColor = lerp(__mainColor, __mainColor_blood, __layer_blood);
...
/* TCP_DATA u config(ver:"2.9.10";unity:"2022.3.62f2";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","OUTLINE","EMISSION"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[,sp(name:"Main Color";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:4;chan:"RGBA";prop:"_Color";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"3a420559-750e-440c-83f1-4525b8c8a16c";op:Multiply;lbl:"Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list["54136b"];unlocked:list[];layer_blend:dict[54136b=LinearInterpolation];custom_blend:dict[54136b="lerp(a, b, s)"];clones:dict[];isClone:False),sp(name:"Alpha";imps:list[imp_spref(cc:1;chan:"A";lsp:"Main Color";guid:"b89139a3-e2cd-43b5-97b8-eebb5915b88b";op:Multiply;lbl:"Alpha";gpu_inst:False;dots_inst:False;locked:False;impl_index:1)];layers:list[];unlocked:list[];layer_blend:dict[54136b=LinearInterpolation];custom_blend:dict[54136b="lerp(a, b, s)"];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[ml(uid:"54136b";name:"Blood";src:sp(name:"layer_54136b";imps:list[imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:1;cc:1;chan:"R";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"Blood";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"8ec09203-72e9-45ee-ba58-0ba0d64028b7";op:Multiply;lbl:"Blood";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1),imp_mp_range(def:0;min:0;max:1;prop:"_BloodAmount";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"de4d01d8-940b-45b8-8081-a2913b154f22";op:Multiply;lbl:"BloodAmount";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False);use_contrast:False;ctrst:__NULL__;use_noise:False;noise:__NULL__)]) */
/* TCP_HASH bb2c2f893596fab9931e8d91bbee4fdc */
